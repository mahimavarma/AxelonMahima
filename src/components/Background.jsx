...
const CybersecurityBackground = ({ children }) => {
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ minHeight: '100vh', minHeight: '100dvh' }}>
      ...
      {/* Content */}
      <div className="relative z-10" style={{ minHeight: '100vh', minHeight: '100dvh' }}>
        {children}
      </div>
    </div>
  );
